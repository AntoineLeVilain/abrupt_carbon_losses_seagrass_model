...
setwd('/Users/antoinelevilain/Desktop/doctorat/my_articles/second/second_article/figures/sens_all_the_way/1_no_f') # set your working directory
...
progress_file <- "progress_ld_healthy.txt"
...
write.csv(full.dt, "ld_healthy.csv")
...
saveRDS(ind, file="ld_healthy_S.RData")
saveRDS(ind.dummy, file="ld_healthy_S.dummy.RData")
...
saveRDS(ind, file="ld_healthy_C.RData")
saveRDS(ind.dummy, file="ld_healthy_C.dummy.RData")

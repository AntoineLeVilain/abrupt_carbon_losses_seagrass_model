...
setwd('/sensitivity/3_no_f') # set your working directory
...
progress_file <- "progress_ld_deter_ma.txt"
...
write.csv(full.dt, "ld_deter_ma.csv")
...
saveRDS(ind, file="ld_deter_ma_S.RData")
saveRDS(ind.dummy, file="ld_deter_ma_S.dummy.RData")
...
saveRDS(ind, file="ld_deter_ma_C.RData")
saveRDS(ind.dummy, file="ld_deter_ma_C.dummy.RData")
...
# Create a progress file
progress_file <- "progress_ld_deter_pmax.txt"
writeLines("Starting computation", progress_file)
...
write.csv(full.dt, "ld_deter_pmax.csv")
...
saveRDS(ind, file="ld_deter_pmax_S.RData")
saveRDS(ind.dummy, file="ld_deter_pmax_S.dummy.RData")
...
saveRDS(ind, file="ld_deter_pmax_C.RData")
saveRDS(ind.dummy, file="ld_deter_pmax_C.dummy.RData")
...
# Create a progress file
progress_file <- "progress_ld_deter_temp.txt"
writeLines("Starting computation", progress_file)
...
write.csv(full.dt, "ld_deter_temp.csv")
...
saveRDS(ind, file="ld_deter_temp_S.RData")
saveRDS(ind.dummy, file="ld_deter_temp_S.dummy.RData")
...
saveRDS(ind, file="ld_deter_temp_C.RData")
saveRDS(ind.dummy, file="ld_deter_temp_C.dummy.RData")

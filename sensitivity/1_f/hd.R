...
progress_file <- "progress_hd_healthy.txt"
...
write.csv(full.dt, "hd_healthy.csv")
...
saveRDS(ind, file="hd_healthy_S.RData")
saveRDS(ind.dummy, file="hd_healthy_S.dummy.RData")
...
saveRDS(ind, file="hd_healthy_C.RData")
saveRDS(ind.dummy, file="hd_healthy_C.dummy.RData")
